...
| VID | PID | Device Name | Layout | Buttons | Description |
|-----|-----|-------------|--------|---------|--------------|
| `0x256b` | `0xc618` | Akamai Box 5x5 - 64 Buttons | 5x5 matrix | 64 | Simple button box with a 5x5 pin layout, firmware-expanded to 64 joystick buttons. |
