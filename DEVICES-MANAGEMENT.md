...
| `0x255a` | `0xc613` | Akamai Steering Wheel 6x4 v2.3.1 - 96 Buttons | 6x4 matrix | 96 | Configurable | v2.3.1 | true | DIY steering wheel with 2 three-way momentary toggle switches, 12 push buttons, 2 paddle shifters, and 4 rotary encoders with pushable button. Physical inputs are firmware-expanded to 96 joystick buttons. |
